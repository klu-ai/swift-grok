...
extension GrokCLI {
    ...
    static var interactiveCommandSpecs: [CommandSpec] {
        ...
        CommandSpec(command: "/audio", aliases: [], description: "Record audio, edit the transcript, then send"),
        CommandSpec(command: "/audio <path>", aliases: ["/audio file <path>"], description: "Transcribe audio, edit the text, then send"),
        CommandSpec(command: "/audio send <path>", aliases: ["/audio-send <path>"], description: "Transcribe audio and send immediately"),
